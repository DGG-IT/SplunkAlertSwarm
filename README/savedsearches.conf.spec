...
# action.<SHC_SwarmAlertWebhook> = [0|1]
action.SHC_SwarmAlertWebhook = 1

# TODO: Add all alert instance-specific parameters below.
# action.<alertaction_name>.param.<key> = <type> (e.g. <string>)
action.SHC_SwarmAlertWebhook.param.SwarmEndpointTopic = <string>
action.SHC_SwarmAlertWebhook.param.SwarmEndpointID = <string>
action.SHC_SwarmAlertWebhook.param.SwarmEndpointComment = <string>
